...
class PatientCallInitialAdmin(CrfModelAdminMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('subject_visit',
                       ...
                       'cd4_count',
                       'cd4_count_date',
                       'cd4_count_date_estimated',
                       'cd4_count_date_estimation',
                       'reason_cd4_unknown',
                       'vl_results_known',
                       'vl_results',
                       'vl_results_date',
                       'vl_results_date_estimated',
                       'vl_results_date_estimation',
                       'reason_vl_unknown',
    ...
    radio_fields = {'education_level': admin.VERTICAL,
                    ...
                    'cd4_count_known': admin.VERTICAL,
                    'vl_results_known': admin.VERTICAL,
                    'vl_results': admin.VERTICAL,
                    'cd4_count_date_estimated': admin.VERTICAL,
                    'cd4_count_date_estimation': admin.VERTICAL,
                    'vl_results_date_estimated': admin.VERTICAL,
                    'vl_results_date_estimation': admin.VERTICAL,
